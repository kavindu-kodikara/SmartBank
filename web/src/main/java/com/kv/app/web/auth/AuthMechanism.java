    ...
    public AuthenticationStatus validateRequest(HttpServletRequest request, HttpServletResponse response, HttpMessageContext context) throws AuthenticationException {
        ...
        if(authParameters.getCredential() != null){
            ...
            if(result.getStatus() == CredentialValidationResult.Status.VALID){
                ...
                request.getSession().setAttribute("pendingValidateResult",result);
        ...
        if(request.getSession().getAttribute("verifiedUser") != null){
            CredentialValidationResult result = (CredentialValidationResult) request.getSession().getAttribute("verifiedUser");
